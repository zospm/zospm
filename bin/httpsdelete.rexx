/* REXX */
/*
 * httpsdelete: Securely connect to a server and issue a DELETE request
 * For syntax: httpsdelete -?
 */
trace 'o'
...
if connectionPort == '' then do
 ...
 call HTTP_setupRequest verbose, user, password, requestPath, connectionURI, "HWTH_HTTP_REQUEST_DELETE", requestBody
...
Syntax:Procedure
Trace 'o'
  call SayErr "Syntax: httpsdelete [-i <infile>|-o <outfile>|-v <tracefile>|-u <user:password>|-l <client-certificate-label>|-r <key-ring>]* <url>"
  call SayErr "  -V  : print out the version of httpsdelete in the form: httpsdelete Vvrm (currently V101)"
